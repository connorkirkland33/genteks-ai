...
**Status:** Production — Deployed on dedicated Ubuntu server
...
Fill in your Anthropic API key and MySQL password.
...
Access the platform at `http://SERVER_IP:8000`
...
|-------|--------|-------------|
| Phase 1 | ✅ Complete | Core platform, web UI, dual-mode chat, file browser, real-time streaming |
